...
export default function MenuTop() {
    return (
        <div className=" flx-menu">
            ...
            <a className="t-item-menu" href="haba">MV</a>
            <a className="t-item-menu" href="haba">ALLBUM</a>
            <a className="t-item-menu" href="haba">NGHỆ SĨ</a>
            <a className="t-item-menu" href="haba">NHẠC CÁ NHÂN </a>
            <a className="t-item-menu t-vip" href="haba">mp3</a>
        </div>
    )
}